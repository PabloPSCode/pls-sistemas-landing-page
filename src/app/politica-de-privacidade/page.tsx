      ...
      <div className="mx-auto w-full max-w-5xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <div className="space-y-5">
          <PolicySection title="1. Quem somos">
            <Paragraph
              content="A PLS Sistemas é uma empresa de desenvolvimento de software, websites e soluções web, sediada em João Monlevade - Minas Gerais. Para fins da LGPD, a PLS Sistemas poderá atuar como Controladora ou Operadora de dados pessoais, conforme a natureza de cada serviço contratado."
